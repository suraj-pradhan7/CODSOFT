        ...
        if(!animating)
            {
                animating=true;
                gsap.to(h1s[index],{
                    top:"-=100%",ease:Expo.easeInOut,duration:1,onComplete:function(){
                ...
                gsap.to(h1s[index],{
                    top:"-=100%",ease:Expo.easeInOut,duration:1,
                });
